      ...
      <Container style={{ width: '70%' }}>
        <Grid divided='vertically'>
          ...
          <Grid.Row columns={2}>
            ...
            <Grid.Column>
              <Segment inverted size='large'>
                Scifan chain是一个专注于科幻小说产业的应用区块链。Sci Fan Chain分别代表科学、幻想和区块链。scifan链的概念是重塑科幻小说产业的生产关系，使科幻小说产业价值创造更加高效，分配更加合理公平。其核心目标是捕捉科幻产业的价值，充分利用新思维、新技术、新生态建设模式，让创作者、读者、投资者、传播者和运营商以前所未有的方式进行创造性合作，推动科幻产业的快速发展。
              </Segment>
            </Grid.Column>
            <Grid.Column>
          ...
          <Grid.Row columns={2}>
            ...
            <Grid.Column>
              <Segment inverted size='large'>
                Scifan链从上游获取科幻产业链的资源和价值。经过一系列的技术处理，最终使其在现实中得到应用，形成一个完整的闭环。Scifan链上所有作品的价值都可以进入现实世界。书面作品可以衍生CG、3D模型、VR、影视作品，可以成为纸质出版物和电子出版物，可以通过订阅方式直接在线分发给读者。它们最终将产生真正的价值。当这个链条逐渐发展和成熟时，它将成为整个科幻小说产业的基础设施。各种线下公司、机构和员工都可以将他们的劳动成果附加到链上。那时，Scifan链抓住了所有行业的价值，这些价值真正属于创造它的人，不会被任何特权、财阀或垄断者剥夺。
              </Segment>
            </Grid.Column>
          </Grid.Row>
          ...
          <Grid.Row columns={2}>
            <Grid.Column>
              <Segment inverted size='large'>
                Scifan链上的每一项工作都具有独特的价值。在作品的创作过程中使用了多种技术。它们都构成了作品的基因，使其意义远远超出了作品本身的内容。
                Scifan chain使用人工创建来代替算法挖掘。我们坚信，语言、科学和艺术、想象力和思维，以及星光灿烂的宇宙都是有价值的，创造者可以将它们挖掘出来，而算法对此无能为力。Scifan链的代币经济基于人类的创造力和劳动。围绕创作过程设计了一系列算法和协议，以合理表达作品在不同阶段的价值。简言之，我们使用字数作为参考来表示作品的数量价值，而作品的质量价值则通过等级和成熟度来表示。定量值由程序统计给出，质量值由社区通过完全投票进行评估。
              </Segment>
